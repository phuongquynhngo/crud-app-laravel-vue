          ...
          <form name="createForm" @submit.prevent="submit">
            <div class="flex flex-col">
              <div class="mb-4">
                ...
                <QInput id="name" type="text" class="mt-1 block w-full" v-model="form.name" autofocus />
                <span class="text-red-600"> form.errors.name </span>
              </div>
              <div class="mb-4">
                <QLabel for="sku" value="SKU" />
                <QInput id="name" type="text" class="mt-1 block w-full" v-model="form.sku" autofocus />
                <span class="text-red-600"> form.errors.sku </span>
              </div>
              <div class="mb-4">
                <QLabel for="detail" value="Detail" />
                <QTextArea id="detail" class="mt-1 block w-full" v-model="form.detail" autofocus />
